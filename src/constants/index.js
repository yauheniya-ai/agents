...
const firstColumnProjects = [
  ...
  },
  {
    ...
    description:
      "intelligently parses the hospital order form to create a concise summary for the drone operator, incorporating human feedback through voice input using Gradio and OpenAI's Whisper API for enhanced accuracy and real-time validation of extracted information",
